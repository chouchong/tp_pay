...
class SDKConfig
{
	...
	// 签名证书路径
	const SDK_SIGN_CERT_PATH = EXTEND_PATH.'unionpay/certs/700000000000001_acp.pfx';

	// 签名证书密码
	const SDK_SIGN_CERT_PWD = '000000';

	// 密码加密证书（这条一般用不到的请随便配）
	const SDK_ENCRYPT_CERT_PATH = EXTEND_PATH.'unionpay/certs/acp_test_verify_sign_new.cer';

	// 验签证书路径（请配到文件夹，不要配到具体文件）
	const SDK_VERIFY_CERT_DIR = EXTEND_PATH.'unionpay/certs/';
	...
	//文件下载目录
	const SDK_FILE_DOWN_PATH = EXTEND_PATH.'unionpay/file/';

	//日志 目录
	const SDK_LOG_FILE_PATH = EXTEND_PATH.'unionpay/logs/';

	//日志级别，开PhpLog::DEBUG关掉的话改PhpLog::OFF
